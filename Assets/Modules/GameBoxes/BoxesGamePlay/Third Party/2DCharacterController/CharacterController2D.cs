...
public class CharacterController2D : MonoBehaviour
{
	...
	[SerializeField] private bool m_DoubleJump = false;							// Allows double jump.
	[SerializeField] private LayerMask m_WhatIsGround = default;							// A mask determining what is ground to the character
	[SerializeField] private Transform m_GroundCheck = default;							// A position marking where to check if the player is grounded.
